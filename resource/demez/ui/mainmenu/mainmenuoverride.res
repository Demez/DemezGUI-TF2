"resource/ui/mainmenuoverride.res"
{
	...
	"NoGCMessage"
	{
		...
		"labelText"		"Disconnected" //"#TF_MM_NoGC_Rank"
		"textAlignment"	"center"
	...
	"FriendsContainer"
	{
		...
		"TitleLabel"
		{
			...
			// hey enable these if you want this for whatever reason
			// also make sure to add 20 to the ypos and the tall value so it will be
			// "ypos" "24" and "tall" "f28"
			"visible"			"0"
			"enabled"			"0"
		...
		"SteamFriendsList"
		{
			...
			"inset_y"			"4"
			"row_gap"			"4"
			"column_gap"			"12" // unused now
			"restrict_width"		"0"

			"friendpanel_kv"
			{	
				// 128 w/ scrollbar, 136 w/out scrollbar
				"wide"		"128" //"136"
				"tall"		"20"
			}
			...
			"ScrollBar"
			{
				...
				"ypos"				"0"
				"tall"				"f0+8"
				"wide"				"9" //"5" // This gets slammed from client schme.  GG.
				"zpos"				"1000"
				"nobuttons"			"1"
				"proportionaltoparent"	"1"
				"visible"			"1"
